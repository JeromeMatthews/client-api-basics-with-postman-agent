...
}; // type is 'success' or 'error' for the CSS class to use
...
var saveSettingsBtn = document.querySelector('.btn--save-settings');
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 7:
              ...
              document.getElementById('password-confirm').value = ''; //As a security precaution we clear all the password fields after the update is complete. Remember: This is done after the updateSettings function is executed, given that it is an async operation, we must await it so that the clearing of the password fields is done at the right time.
